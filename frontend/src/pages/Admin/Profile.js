...
<div className="flex flex-col items-center p-4  lg:w-full w-[400px] h-full">
    ...
    <form onSubmit={handleSubmit} className="flex-1">
      <div className="flex flex-col w-full lg:w-2/3 p-4 space-y-4">
        ...
        <input
          className="lg:w-full p-2 shadow-md bg-slate-50 dark:bg-slate-700 rounded"
          value={user.name || ""}
        ...
        />
        <textarea
          className="w-full h-20 p-2 shadow-md bg-slate-50 dark:bg-slate-700 rounded"
          value={user.Address || ""}
          onChange={handleChange}
          name="Address"
        ...
        <button className="w-full py-2 rounded-xl bg-blue-500 text-white text-lg hover:bg-red-600">
          Update
        </button>
      </div>
    </form>
